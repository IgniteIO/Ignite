...
<html lang="en">
    ...
    <body>
                ...
                <?php } else { ?>
                    <form class="form-horizontal" id="global-options">
                        <fieldset>
                            ...
                            <p><strong>What happened to the other options?</strong> We're working on implementing a new editor at the moment, they'll be back soon though!</p>
                        </fieldset>
                    </form>
                <?php } ?>
            </div>
        ...
        <div id="about">
            ...
            <div class="content">
                ...
                <p>You can get started by simply writing code, or pasting your existing code here. After that you can hit Play or Save. Playing code automatically compiles and saves it.</p>
                <p>If you find any problems feel free to join us on irc at irc.esper.net #axxim or email me at luke@axxim.net</p>
    ...
    <script id="fires-template" type="text/x-handlebars-template">
        ...
        <div class="modal-body">
            <p><a href="<?php echo base_url('/api/user/dump'); ?>/{{username}}" class="dump">Download all of my fires as a .zip</a></p>
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{timestamp}}</td>
                        <td><!--<a href="#" data-id="{{_id.$id}}" class="delete" style="text-decoration: none; color: red;"><i class="icon-remove"></i></a>--></td>
                    </tr>
                    {{/fires}}
                </tbody>
            </table>
